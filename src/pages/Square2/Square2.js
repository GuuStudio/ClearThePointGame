...
import styles from "./Square2.module.scss";

import happy from "../../assets/images/firecracker.svg";
import sad from "../../assets/images/sad.svg";
import ButtonNumberNew from "../../components/ButtonNumber/ButtonNumber";
...
const Square2 = () => {
    ...
    const handleRestart = () => {
        ...
        if (startNumber > 0 && startNumber <= 1000) {
            const newButtons = [];
